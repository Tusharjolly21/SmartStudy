          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12 ">
              <div>
                ...
                <p className="center mx-auto mb-4 flex max-w-screen-lg items-center justify-center text-xl sm:flex-col md:sm:flex lg:flex lg:w-full">
                  {blog.attributes.Summary}
                </p>
                <div className="mb-10 w-full overflow-hidden rounded">
                  <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                    <Image
                      src={`${process.env.STRAPI_URL}${blog.attributes.FeaturedImage.data.attributes.url}`}
                      alt="image"
                      fill
            ...
            {blog.attributes.Content.map((content) =>
              content.children.map((child) => (
                <>
                  <br />
                  <div
                    className="center mx-auto flex max-w-screen-lg items-center justify-center text-xl sm:flex-col md:sm:flex lg:flex lg:w-full"
                    key={blog.id}
