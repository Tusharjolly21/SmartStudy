  ...
  return (
    ...
    >
      <div className="container mt-12">
        <SectionTitle title="India:Size and Location" paragraph="" center />
          ...
          <div className="container grid max-w-4xl items-start justify-start gap-8 px-4 md:px-6">
            <div className="space-y-4">
              ...
              <p className="break-words text-justify text-base dark:text-gray-400">
                ...
                Continent of Asia. The word India has its origin in Greek
                Mythology which referred to the land of{" "}
                <span className="font-bold"> &quot;Indoi&quot; </span> or people
                dwelling near the river Indus. India has been regarded by many
                names like- <span className="font-bold"> Aryavarta </span>(The
                land of the Aryan race), Bharat, and{" "}
              ...
              <p className="break-words text-justify text-base  dark:text-gray-400">
                ...
                <span className="font-bold"> Himalayas </span> ranges in the
                north to the shores of the Indian Ocean in the south and the
                <span className="font-bold"> Arabian Sea </span> in the
                south-west to the{" "}
                <span className="font-bold"> Bay of Bengal </span> in the
                south-east. It also encompasses a diverse landmass that varies
                from permanently ice- covered lofty Himalayas to Great
                <span className="font-bold"> Indo-Gangetic Plains. </span> It
                spans from vegetation devoid of{" "}
                <span className="font-bold"> Thar Desert </span> in the west to
                vegetation abundant in the hilly north-east. The land mass is as
                old as the oldest land of{" "}
                <span className="font-bold"> Godwana</span> in the Indian
              ...
              <p className="break-words text-justify text-base  dark:text-gray-400">
                ...
                longitudes{" "}
                <span className="font-bold"> 68°7’E and 97°25’E</span>. Both
                latitudinal and longitudinal extent is about{" "}
                <span className="font-bold">thirty</span> degrees. India extends
                from Indira Ridge in Kashmir to Kanyakumari in Tami Nadu with
                <span className="font-bold"> 3214</span> kilometers. The
                west-east extent of India spans from Rann of Kutch in Gujarat in
                the west to Kibuthu (the easternmost town) in Arunachal Pradesh
                in the east with a distance of{" "}
                <span className="font-bold"> 2933</span> kilometers. The Indian
                landmass has an area of <span className="font-bold"> 3.28</span>{" "}
                million square kilometers, which is around{" "}
              ...
              <p className="break-words text-justify text-base  dark:text-gray-400">
                ...
                hours. Thus, Arunachal sees the sun rising 2 hours earlier than
                Saurashtra in the west. The standard meridian in India 82°30’E
                longitude passes through{" "}
                <span className="font-bold"> Mirzapur</span> in{" "}
                <span className="font-bold"> Uttar Pradesh</span>. Indian
                standard time (82°30’E) passes through the states{" "}
                <span className="font-bold">
                  Uttar Pradesh, Madhya Pradesh, Chhattisgarh, Odisha, Andhra
            ...
            <div className="space-y-4">
              <p className="break-words text-justify text-base dark:text-gray-400">
                ...
                islands (Andaman & Nicobar Islands and Lakshadweep ) is
                approximately <span className="font-bold">7516.6</span>{" "}
                kilometers. The length of the coastline of the mainland is about
              ...
              <p className="break-words text-justify text-base  dark:text-gray-400">
                ...
                Tropic of Cancer division, approximately half of India’s
                ...
                <span className="font-bold">tropical</span> country than a
